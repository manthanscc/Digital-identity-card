...
export const ProfileForm: React.FC = () => {
  ...
  const {
    ...
    defaultValues: {
      social_links: [{ platform: 'instagram', url: '', username: '' }],
  ...
  const onSubmit = async (data: ProfileFormData) => {
    try {
      ...
      if (data.social_links.length > 0) {
        const socialLinksData = data.social_links.map(link => ({
          ...
          <CardContent className="space-y-4">
            {socialFields.map((field, index) => (
              <div key={field.id} className="grid grid-cols-1 md:grid-cols-4 gap-4 p-4 border rounded">
                ...
                <div>
                  <Label>URL</Label>
                  <Input {...register(`social_links.${index}.url`)} />
                </div>
                <div>
                  <Label>Username</Label>
                  <Input {...register(`social_links.${index}.username`)} />
                </div>
              ...
              <div key={field.id} className="p-4 border rounded space-y-4">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  ...
                  <div>
                    ...
                    <Input {...register(`services.${index}.price`)} />
                  </div>
                </div>
                <div>
          ...
          <CardContent className="space-y-4">
            {businessHourFields.map((field, index) => (
              <div key={field.id} className="grid grid-cols-1 md:grid-cols-3 gap-4 items-center">
                ...
                <div>
                  <Input {...register(`business_hours.${index}.hours`)} />
                </div>
